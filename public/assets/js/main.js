(function ($) {
  ...
  var fractionPagination = document.querySelector(
    ".hero-img-fraction-pagination"
  );

  if (fractionPagination) {
    // Only run this block if the element exists
  ...
  var imageElementsTestimonial = document.querySelectorAll(
